...
print("=============================================")
print("Result of combin heads:")

batch_size, _, seq_length, d_k = output.size()
print("batch_size: ", batch_size)
print("seq_length: ", seq_length)
output_reshape = output.transpose(1, 2).contiguous().view(batch_size, seq_length, d_model)
print("output_reshape: ", output_reshape)
print("output_reshape size: ", output_reshape.size())
final_output = W_o(output_reshape)
